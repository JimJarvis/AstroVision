...
% - isNoisy: if it's noisy, we adapt the bins to the 2nd level 
%   (first blur level) instead of the original image. 
%
% returns:
...
%
function [] = imgAdaptBin(datasets, nBins, nSample, isNoisy)
